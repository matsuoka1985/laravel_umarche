                                        ...
                                        @foreach ($categories as $category)
                                            <optgroup label="{{$category->name}}">
                                                @foreach ($category->secondary as $secondary)
                                                    <option value="{{$secondary->id}}" {{ $product->secondary_category_id === $secondary->id ? 'selected':'' }} >
                                                        {{$secondary->name}}
                                                    </option>
                                                @endforeach
                                            </optgroup>
...
<script>
"use strict";
const images = document.querySelectorAll(".image"); //クラス名にimageとついているものを全て取得
images.forEach(image => { //上で取得したタグ全てのループで回す。
